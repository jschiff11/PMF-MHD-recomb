...
def main(input_bind, input_epsind):
    ...
    xe_full_He = pars.xe_full_He     # He-inclusive background weight for the xe2/xe normalization
    ...
    visibprefactor = (1 + (xe2/xe_full_He(zarr)) - dtaudtaudotcross )*np.exp(-dtau2 + dtaurms/2)
