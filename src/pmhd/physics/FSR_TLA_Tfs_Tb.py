...
def main(input_bind, input_kind):
    ...
    # Output base directory (Tb subdirectory following ang_avg/Tb convention)
    ...
    ## Solve for homogeneous baryon temperature
    sol_Tb = odeint(pars.RHSTbhom, pars.Tcmb(1900), np.arange(1900,600,-0.01), args=(xe_full,))
    ...
    for thetaind in range(len(thetaarr)):
        ...
        sol = solve_ivp( pars.FSRTLAmag_Tb, [zstartarr[input_kind], zend],
                ...
                args=(
                    ...
                    xe_full, abarinterpfunc, bbarinterpfunc, cbarinterpfunc,
